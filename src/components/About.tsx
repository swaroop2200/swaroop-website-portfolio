    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <Card className="p-8 backdrop-blur-sm bg-white/50 border border-gray-200 hover:bg-pink-100/80 hover:border-pink-200 transform hover:-translate-y-1 transition-all duration-300">
