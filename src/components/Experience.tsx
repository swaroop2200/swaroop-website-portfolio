        ...
        <div className="space-y-6">
          {experiences.map((exp, index) => (
            ...
            >
              ...
              >
                <Card className="overflow-hidden backdrop-blur-md bg-white/80 border border-gray-200/50 shadow-lg hover:shadow-xl hover:shadow-blue-100/50 hover:border-blue-200/50 hover:bg-gradient-to-br hover:from-white hover:to-blue-50/30 transform hover:-translate-y-1 hover:scale-[1.01] transition-all duration-300">
                  <CollapsibleTrigger className="w-full">
                    <div className="p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-transparent transition-colors duration-300">
                  ...
                  <CollapsibleContent>
                    <div className="px-6 pb-6 space-y-4 border-t border-gray-100/50 bg-transparent">
